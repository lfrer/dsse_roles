...
from src.policies.r3dm_lstm_policy import R3DMRolePPOTorchPolicyLSTM
...
def train_ppo_lstm_roles(
    ...
    rollout_fragment_length = train_config.get("rollout_fragment_length", 64)
    ...
    keep_checkpoints_num = int(train_config.get("keep_checkpoints_num", 10))
    ...
    policies = {
        "shared_policy": (
            R3DMRolePPOTorchPolicyLSTM,
            _to_dict_obs_space(obs_space),   
            act_space,
            {},
    ),
}
